	...
	<div class="funbtn" style="padding-left: 300px"> 
			<div class="search col-md-4"> 
						<div class="input-group">
							<form action="jsp/admin/findOrderDealByName.do" method="post">
				...
				<c:when  test="${!empty orderList}">
					<c:forEach items="${orderList}" var="i">
						<tr>
							...
							<td>
								<a class="btn btn-default btn-sm" href="jsp/admin/orderDetail.do?id=${i.orderId}">详情</a>
								<a class="btn btn-info btn-sm" href="jsp/admin/orderProcessing.do?id=${i.orderId}" onclick="return confirm('确定要发货了么！')">发货</a>
							</td>
						</tr>
					</c:forEach>
				</c:when>
...
<script type="text/javascript">
	...
	$(".homePage").click(function(){
		window.location="${basePath}jsp/admin/queryOrderHandle.do?page=1";
	})
	$(".prePage").click(function(){
		window.location="${basePath}jsp/admin/queryOrderHandle.do?page=${pageBean.prePage}";
	})
	$(".nextPage").click(function(){
		window.location="${basePath}jsp/admin/queryOrderHandle.do?page=${pageBean.nextPage}";
	})
	$(".lastPage").click(function(){
		window.location="${basePath}jsp/admin/queryOrderHandle.do?page=${pageBean.pageCount}";
	})
	//控制页面跳转范围
	$(".page-go").click(function(){
		...
		if(page > pageCount || page < 1 ){
			...
			window.location="${basePath}jsp/admin/queryOrderHandle.do?page="+page;
		}
	})
