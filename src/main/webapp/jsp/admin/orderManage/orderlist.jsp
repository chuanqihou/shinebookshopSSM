	...
	<div class="funbtn" style="padding-left: 300px"> 
			<div class="search col-md-4"> 
						<div class="input-group">
							<form action="jsp/admin/findOrderByName.do" method="post">
					...
					<c:forEach items="${orderList}" var="i">
						<tr>
							...
							<td>
								...
								<a class="btn btn-danger btn-sm" href="jsp/admin/orderDelete.do?id=${i.orderId}" onclick="javascript:return confirm('确定要删除吗？');">删除</a>
							</td>
						</tr>
					</c:forEach>
				</c:when>
...
<script type="text/javascript">
	...
	$(".homePage").click(function(){
		window.location="${basePath}jsp/admin/queryAllOrder.do?page=1";
	})
	$(".prePage").click(function(){
		window.location="${basePath}jsp/admin/queryAllOrder.do?page=${pageBean.prePage}";
	})
	$(".nextPage").click(function(){
		window.location="${basePath}jsp/admin/queryAllOrder.do?page=${pageBean.nextPage}";
	})
	$(".lastPage").click(function(){
		window.location="${basePath}jsp/admin/queryAllOrder.do?page=${pageBean.pageCount}";
	})
	//控制页面跳转范围
	$(".page-go").click(function(){
		...
		if(page > pageCount || page < 1 ){
			...
			window.location="${basePath}jsp/admin/queryAllOrder.do?page="+page;
		}
	})
