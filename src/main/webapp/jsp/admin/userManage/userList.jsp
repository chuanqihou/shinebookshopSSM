		...
		<div class="funbtn">
			...
			<div class="search col-md-4">
						<div class="input-group">
							<form action="jsp/admin/searchUserByUserName.do" method="get">
				...
				<c:when  test="${!empty userList}">
					<c:forEach items="${userList}" var="i" varStatus="n">
						<tr>
							...
							<td>
								<a class="btn btn-default btn-sm" href="jsp/admin/userDetail.do?id=${i.userId}">详情</a>
								<a class="btn btn-info btn-sm" href="jsp/admin/userEditById.do?id=${i.userId}">修改</a>
								<a class="btn btn-danger btn-sm" href="jsp/admin/userDeleteById.do?id=${i.userId}" onclick="javascript:return confirm('确定要删除吗？');">删除</a>
							</td>
						</tr>
					</c:forEach>
				</c:when>
...
<script type="text/javascript">
	...
	$("#batDel").click(function(){
		...
		if(confirm("你确定要删除"+choices.length+"条用户吗？")){
			...
			window.location="${basePath}jsp/admin/userDeletesByIds.do?"+idParam;
		}
	})
