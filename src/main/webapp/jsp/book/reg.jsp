        ...
        <div class="main container">
            ...
            <div id="myTabContent" class="tab-content">
                <div id="tab_reg" class="tab-pane fade">
                    <form id="regForm" action="userRegister.do" method="post" class="form-horizontal">
                    ...
                    <form id="loginForm" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4" style="padding:0;">
                                <img class="col-md-8" id="imgCode" onclick="reCode()" alt=""
    ...
    $(function () {
        ...
        $("#loginForm").submit(function () {
            $.post("userLogin.do", $('#loginForm').serialize(), function (data) {
                if ("y" == data.status) {
                    alert("登录成功！")
                    window.location.href = "${basePath}jsp/book/index.jsp";
                } else {
                    $(".info").html(data.info);
                }
            }, "json")
