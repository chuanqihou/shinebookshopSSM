...
<div class="container">
    ...
    <div class="row">
    	...
    	<div class="col-sm-4 ">
    		<div class="img-box" onclick="javascript:upImg()">
    			<img alt="" height="100px" src="${bookInfo.imgSrc}" >
    		</div>
    		<span id="imgSpan">点击图片更改图片</span>
    		<form id="imgForm" action="jsp/admin/updateBookImage.do?id=${bookInfo.bookId}" method="post" enctype="multipart/form-data">
    ...
    <form id="bookAddForm" class="form-horizontal" action="jsp/admin/updateBook.do" method="post">
        <input type="hidden" name="bookId" value="${bookInfo.bookId}">
       
        <div class="form-group">
            <label for="catalog" class="col-sm-2 col-sm-offset-2 control-label">图书类型</label>
            <div class="col-sm-4">
                <select name="catalogId" id="catalog" class="form-control">
                    <option value="">==请选择图书类型==</option>
                    <c:if test="${!empty catalog}">
                        <c:forEach items="${catalog}" var="i">
                            <c:choose>
                                <c:when test="${i.catalogId eq bookInfo.catalogId}">
