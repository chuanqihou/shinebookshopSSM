...
<head>
    ...
    <title>图示商城-我的订单</title>
    <link rel="stylesheet" href="bs/css/bootstrap.css">
	<link href="css/book/head_footer.css" rel="stylesheet" type="text/css">
	<link href="css/book/myOrderList.css" rel="stylesheet" type="text/css">
                    ...
                    <c:when test="${!empty orderList }">
                        <c:forEach items="${orderList}" var="order" varStatus="varstatus">
                            ...
                            <c:forEach items="${order.oItem}" var="oit" varStatus="vs">
                                <tr>
                                    <td>
                                        <img class="img-responsive col-md-2" src="${oit.book.imgSrc}" alt=""/>
                                        ...
                                        <c:when test="${vs.first}">
                                            ...
                                            <td style="border:0;border-left:1px solid #ddd;">
                                                ...
                                                <c:if test="${order.orderStatus eq 2}">
                                                    <p>已发货</p>
                                                    <a href="confirmReceipt.do?id=${order.orderId}"
...
<script type="text/javascript">
    ...
    $(".homePage").click(function () {
        window.location = "${bsePath}viewOrder.do?page=1";
    })
    $(".prePage").click(function () {
        window.location = "${basePath}viewOrder.do?page=${pageBean.prePage}";
    })
    $(".nextPage").click(function () {

        window.location = "${basePath}viewOrder.do?page=${pageBean.nextPage}";
    })
    $(".lastPage").click(function () {
        window.location = "${basePath}viewOrder.do?page=${pageBean.pageCount}";
    })
    //控制页面跳转范围
    $(".page-go").click(function () {
        ...
        if (page > pageCount || page < 1) {
            ...
            window.location = "${basePath}viewOrder.do?page=" + page;
        }
    })
